...
@section('title','Call Session Form')
@section('content')

<style>
    /* Menggunakan style yang sama untuk konsistensi antar form online */
    ...
    .btn-pink-mystic {
        ...
        padding: 18px 40px; border-radius: 50px; font-weight: bold; width: 100%; text-transform: uppercase; transition: 0.3s;
    }
        ...
        <div class="booking-card-mystic wow fadeInUp">
            <form action="/booking/store" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6"><label class="form-label">No WhatsApp</label><input type="text" name="phone" class="form-control" required></div>
                </div>
                ...
                <div class="text-center mt-5" style="border-top: 1px solid #3d3020; padding-top: 25px;">
                    ...
                    <button type="submit" class="btn-pink-mystic">HUBUNGI SAYA SEKARANG</button>
                </div>
            </form>
        </div>
    </div>
